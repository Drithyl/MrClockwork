	...
	if (aiplayers === "none")
  {
    ...
    if (difficulty != "easy" && difficulty != "normal" && difficulty != "difficult" && difficulty != "mighty" && difficulty != "master" && difficulty != "impossible")
    {
      ...
      return result;
		...
		if (module.exports.instances[username].settingsPack.era == 1 && (natNumber < 5 || natNumber > 22) && (natNumber < 24 || natNumber > 32) && (natNumber < 36 || natNumber > 40))
		{
			result.data = "You can only add nations for the selected era (Early Age). To see a list, type `%nations`.";
      return result;
    }

		if (module.exports.instances[username].settingsPack.era == 2 && (natNumber < 43 || natNumber > 70) && (natNumber < 73 || natNumber > 77))
		{
